...
**Runtime delivery:** `window.prcChartBuilderTheme` on every page load (read-only). Palettes resolve by slug via `getResolvedPalettes()`; per-role `fontFamily` preset tokens (`var:preset\|font-family\|<slug>`) resolve to concrete stacks via `window.prcChartBuilderTheme.fontFamilies`.
...
**Docs:** `[docs/plans/CHART_BUILDER_THEME_PLAN.md](docs/plans/CHART_BUILDER_THEME_PLAN.md)`.
...
| `layout.orientation`      | `'vertical' \| 'horizontal'`                                                                                                                                                                                                                                                                                                                                             | `"horizontal"`                                  | `"horizontal"`.                                                                       |
| `layout.overflowX`        | `'responsive' \| 'scroll' \| 'preserve-aspect-ratio'`                                                                                                                                                                                                                                                                                                                    | `"responsive"`                                  | 'scroll' \.                                                                           |
...
| `layout.type`             | `'bar' \| 'diverging-bar' \| 'line' \| 'area' \| 'scatter' \| 'pie' \| 'dot-plot' \| 'stacked-bar' \| 'single-stacked-bar' \| 'grouped-bar' \| 'exploded-bar' \| 'stacked-area' \| 'map-usa' \| 'map-usa-counties' \| 'map-usa-cbsa' \| 'map-usa-block' \| 'map-usa-hex' \| 'map-world' \| 'map-world-orthographic' \| 'map-europe' \| 'treemap' \| 'sankey' \| 'radar'` | `"bar"`                                         | 'line' \.                                                                             |
...
| `independentAxis.axisLabel.textAnchor`      | `'start' \| 'middle' \| 'end'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `"end"`      | 'end'`.                                                                           |
| `independentAxis.axisLabel.verticalAnchor`  | `'start' \| 'middle' \| 'end'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `"middle"`   | 'end'`.                                                                           |
...
| `independentAxis.scale`                     | `'linear' \| 'time' \| 'log' \| 'sqrt'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `"linear"`   | 'log' \.                                                                          |
...
| `netValues.negative.fontSize`          | number                         | `10`         | Font size of the negative net value label (px).                     |
...
| `netValues.negative.truncateDecimal`   | boolean                        | `false`      | Drop trailing zeros after the decimal point on negative net values. |
...
| `netValues.positive.fontSize`          | number                         | `10`         | Font size of the positive net value label (px).                     |
...
| `netValues.positive.truncateDecimal`   | boolean                        | `false`      | Drop trailing zeros after the decimal point on positive net values. |
