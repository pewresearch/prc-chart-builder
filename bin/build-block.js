...
(async () => {
	...
	console.log(`Building Block Name: ${response.blockName}`);
	...
	let command = `npx wp-scripts build --webpack-src-dir=${src} --output-path=${output} --webpack-copy-php --experimental-modules`;
