...
function TreemapControls({ attributes, setAttributes, clientId }) {
	...
	const { isOpen, panelRef, onToggle } = useFocusedPanel('treemap');
	...
	return (
		<div ref={panelRef}>
			<PanelBody
				title={__('Treemap Configuration')}
				opened={isOpen}
				onToggle={onToggle}
			>
				<ToolsPanel
				...
				>
					...
					>
						<NumberControl
							...
							help={__('Spacing between parent and child nodes.')}
							withInputField
							min={0}
							max={20}
							step={1}
					...
					>
						<NumberControl
							...
							help={__('Corner rounding for treemap rectangles.')}
							withInputField
							min={0}
							max={20}
							step={1}
