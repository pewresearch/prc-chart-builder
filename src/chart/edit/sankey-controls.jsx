...
function SankeyControls({ attributes, setAttributes, clientId }) {
	...
	const { isOpen, panelRef, onToggle } = useFocusedPanel('sankey');
				...
				>
					...
					>
						<NumberControl
							...
							help={__('Width of the rectangular node bars.')}
							withInputField
							min={2}
							max={60}
							step={1}
					...
					>
						<NumberControl
							...
							help={__('Vertical spacing between nodes.')}
							withInputField
							min={0}
							max={60}
							step={1}
					...
					>
						<NumberControl
							...
							help={__('Corner rounding for node rectangles.')}
							withInputField
							min={0}
							max={20}
							step={1}
